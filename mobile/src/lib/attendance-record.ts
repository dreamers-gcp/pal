/** Professor \"mark absent\" rows use this storage path prefix (web parity). */
...
export function isStudentPresent(record: { verified?: boolean | null } | undefined | null): boolean {
